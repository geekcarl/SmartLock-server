	...
	<body  onkeydown="onKeyDown()" onmousedown="scrollFunc()" oncontextmenu="return false">
		<div class="col-sm-6" id="rightclick_contextmenu" onmouseover="rightMenuMouseOver()" onmouseout="rightMenuMouseOut()" style="display:none; z-index:9999; position: absolute;">
			<ul id="menu">
				...
				<li>
					<a href="javascript:void(0);" onclick="coreToCore()">端子直熔</a>
				</li>
		...
		<div class="main-container" id="main-container" style="background-color: white">
			<script type="text/javascript">
				...
				function dyniframesize(down) { 
					setTimeout("javascript:window.frames['menu'].initmenu(2, 1);", 1);
		        ...
		        <form id="u_form" method="post">
		            ...
		            <table cellpadding="5">
		                <tr>
		                    <td>编号:</td>
		                    <td>
		                    	<input id="a_box_no" name="box_no" type="text"></input>
		                    	<input type="hidden" id="a_id" name="a_id"/>
		                    </td>
		                    <td>控制器:</td>
		                    <td><input type="text" id="a_controller_id" name="controller_id"></input></td>
		                </tr>
		                <tr>
		                    <td>名称:</td>
		                    <td><input type="text" id="a_box_name" name="box_name"></input></td>
		                    <td>位置:</td>
		                ...
		                <tr>
		                    <td>所属部门:</td>
		                    <td>
		                    	<input type="text" id="a_department_name" name="department.name" onfocus="chooseDepartment('a_department_name', 'a_department_id')"></input>
		                ...
		                <tr>
		                    <td>门锁数量:</td>
		                    <td><input type="text" id="a_locks_count" name="locks_count"></input></td>
		                    <td>最近通信时间:</td>
		                    <td>
								<input type="text" id="a_last_heard" name="business.applyDate"   value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
							</td>
		                </tr>
		                <tr>
		                    <td>控制器上电时间:</td>
		                    <td><input type="text" id="a_power_on" name="business.applyDate"   value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"></td>
		                    <td>K码:</td>
		                    <td><input type="text" id="a_k_code" name="k_code"></input></td>
		                </tr>
		                <tr>
		                    <td>百度地图经度:</td>
		                    <td><input type="text" id="a_b_longitude" name="b_longitude"></input></td>
		                    <td>百度地图纬度:</td>
		                    <td><input type="text" id="a_b_latitude" name="b_latitude"></input></td>
		                </tr>
		                <tr>
		                    <td>备注:</td>
		                    <td colspan="3"><textarea id="a_remarks" rows="5" cols="70" name="remarks"></textarea></td>
		                </tr>
		            </table>
		        	<label><h4>2 状态信息</h4></label>
		        	<HR style="border:3 double #987cb9" width="100%" color=#987cb9 SIZE=3>
		        	<table id="boxStates" width="100%">
		        	
		        	</table>
		        	<HR style="border:3 double #987cb9" width="100%" color=#987cb9 SIZE=3>
		        	<label><h4>3 面板信息</h4><a class="green" href="javascript:void(0);" onclick="addBoxModuleRow()"  title="增加面板"><i class="icon-plus bigger-130"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="green" href="javascript:void(0);" onclick="deleteBoxModuleRow()"  title="删除面板"><i class="icon-minus bigger-130"></i></a></label>
		        	<table width="100%">
		        		<tr align="center">
						   <td>模块</td>
						   <td>行数</td>
		        ...
		        <form id="a_form_lock" method="post">
		            ...
		            <table cellpadding="5">
		                ...
		                <tr>
		                    <td>所属部门:</td>
		                    <td>
		                    	<input type="text" id="a_lock_department_name" onfocus="chooseDepartment('a_lock_department_name', 'a_lock_department_id')"></input>
