		...
		<div class="main-container" id="main-container" style="background-color: white">
			<script type="text/javascript">
				...
				function dyniframesize(down) { 
					setTimeout("javascript:window.frames['menu'].initmenu(1, 5);", 1);
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="well well-sm">
									...
									报警类型：<input id="f_s_alarm_type" type="text" placeholder="报警类型"/>
			...
			<div style="padding:10px 50px 20px 50px">
				<form id="d_search_form">
					<table width="100%" height="auto">
						...
						<tr>
							<td>报警时间：</td>
							<td><input type="text" id="s_alarm_time"  value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"></td>
							<td>报警钥匙：</td>
						...
						<tr>
							<td>解除时间：</td>
							<td><input type="text" id="s_settled_time"  value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"></td>
							<td>解除钥匙：</td>
						...
						<tr>
							...
							<td>确认时间：</td>
							<td><input type="text" id="s_affirm_time"  value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"></td>
						</tr>
						<tr>
							<td>确认人：</td>
							<td colspan="3"><input type="text" id="s_affirm_user" value=""/></td>
						</tr>
					</table>
				</form>
			</div>
